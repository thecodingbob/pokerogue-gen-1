...
export enum ChargeAnim {
    FLY_CHARGING = "FLY_CHARGING",
    BOUNCE_CHARGING = "BOUNCE_CHARGING",
    DIG_CHARGING = "DIG_CHARGING",
    FUTURE_SIGHT_CHARGING = "FUTURE_SIGHT_CHARGING",
    DIVE_CHARGING = "DIVE_CHARGING",
    SOLAR_BEAM_CHARGING = "SOLAR_BEAM_CHARGING",
    SHADOW_FORCE_CHARGING = "SHADOW_FORCE_CHARGING",
    SKULL_BASH_CHARGING = "SKULL_BASH_CHARGING",
    FREEZE_SHOCK_CHARGING = "FREEZE_SHOCK_CHARGING",
    SKY_DROP_CHARGING = "SKY_DROP_CHARGING",

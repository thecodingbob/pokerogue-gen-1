...
export function initSpecies() {
  allSpecies.push(
    ...
    new PokemonSpecies(Species.CLEFAIRY, 1, false, false, false, "Fairy Pokémon", Type.FAIRY, null, 0.6, 7.5, 323, 70, 45, 48, 60, 35, 150, 140, 113, GrowthRate.FAST, 25, false),
    new PokemonSpecies(Species.CLEFABLE, 1, false, false, false, "Fairy Pokémon", Type.FAIRY, null, 1.3, 40, 483, 95, 70, 73, 95, 60, 25, 140, 242, GrowthRate.FAST, 25, false),
    ...
    new PokemonSpecies(Species.JIGGLYPUFF, 1, false, false, false, "Balloon Pokémon", Type.NORMAL, Type.FAIRY, 0.5, 5.5, 270, 115, 45, 20, 45, 20, 170, 50, 95, GrowthRate.FAST, 25, false),
    new PokemonSpecies(Species.WIGGLYTUFF, 1, false, false, false, "Balloon Pokémon", Type.NORMAL, Type.FAIRY, 1, 12, 435, 140, 70, 45, 85, 45, 50, 50, 218, GrowthRate.FAST, 25, false),
    ...
    new PokemonSpecies(Species.MAGNEMITE, 1, false, false, false, "Magnet Pokémon", Type.ELECTRIC, Type.STEEL, 0.3, 6, 325, 25, 35, 70, 95, 45, 190, 50, 65, GrowthRate.MEDIUM_FAST, null, false),
    new PokemonSpecies(Species.MAGNETON, 1, false, false, false, "Magnet Pokémon", Type.ELECTRIC, Type.STEEL, 1, 60, 465, 50, 60, 95, 120, 70, 60, 50, 163, GrowthRate.MEDIUM_FAST, null, false),
    ...
    new PokemonSpecies(Species.MR_MIME, 1, false, false, false, "Barrier Pokémon", Type.PSYCHIC, Type.FAIRY, 1.3, 54.5, 460, 40, 45, 65, 100, 90, 45, 50, 161, GrowthRate.MEDIUM_FAST, 50, false),

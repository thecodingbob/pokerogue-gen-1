...
export default class BattleInfo extends Phaser.GameObjects.Container {
  ...
  initInfo(pokemon: Pokemon) {
    ...
    this.splicedIcon.setPositionRelative(this.nameText, nameTextWidth + this.genderText.displayWidth + 1, 2.5);
    ...
    this.shinyIcon.setPositionRelative(this.nameText, nameTextWidth + this.genderText.displayWidth + 1 + (this.splicedIcon.visible ? this.splicedIcon.displayWidth + 1 : 0), 2.5);
  ...
  setMini(mini: boolean): void {
    ...
    const offsetElements = [ this.nameText, this.genderText, this.splicedIcon, this.shinyIcon, this.statusIndicator, this.levelContainer ];
  ...
  updateBossSegments(pokemon: EnemyPokemon): void {
    ...
    if (boss !== this.boss) {
      ...
      [ this.nameText, this.genderText, this.splicedIcon, this.shinyIcon, this.ownedIcon, this.championRibbon, this.statusIndicator, this.levelContainer, this.statValuesContainer ].map(e => e.x += 48 * (boss ? -1 : 1));
  ...
  updateInfo(pokemon: Pokemon, instant?: boolean): Promise<void> {
    return new Promise(resolve => {
      ...
      if (nameUpdated) {
        ...
        this.splicedIcon.setPositionRelative(this.nameText, this.nameText.displayWidth + this.genderText.displayWidth + 1, 1.5);
        this.shinyIcon.setPositionRelative(this.nameText, this.nameText.displayWidth + this.genderText.displayWidth + 1 + (this.splicedIcon.visible ? this.splicedIcon.displayWidth + 1 : 0), 2.5);
      }
